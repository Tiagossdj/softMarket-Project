document.addEventListener('DOMContentLoaded', () => {
    ...
    // Adicionando rotas para os relatórios em Excel
    const reportRoutesExcel = {
        'vendas': 'http://127.0.0.1:5000/relatorio_vendas_excel',
        'estoqueBaixo': 'http://127.0.0.1:5000/relatorio_estoque_baixo_excel',
        'produtosVendidos': 'http://127.0.0.1:5000/relatorio_compras_excel',
        'vendasDiarias': 'http://127.0.0.1:5000/relatorio_vendas_dia_excel',
        'fornecedores': 'http://127.0.0.1:5000/relatorio_fornecedores_excel',
        'estoque': 'http://127.0.0.1:5000/relatorio_estoque_excel',
        'pedidosEstoque': 'http://127.0.0.1:5000/relatorio_pedidos_estoque_excel'
    };
    ...
    async function handleExportExcel() {
        ...
        // Use a rota para Excel
        const reportRoute = reportRoutesExcel[reportType];
        const reportUrl = new URL(reportRoute);
